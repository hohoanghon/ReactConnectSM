...
export default function App() {
  ...
  const address = "0xe6189edd91d811a010367a1f571f5c44379aabd2";
  ...
  const getInfoOwner = async () =>
  {
    const provider = new ethers.providers.Web3Provider(window.ethereum);
    const erc20 = new ethers.Contract(address, erc20abi, provider);
    const ownerInfo = await erc20.owner();
    setOwnerInfo ({
      ownerAddress: ownerInfo
    })

  }

  return (
    <div className="grid grid-cols-1 gap-2 md:grid-cols-2" style={{width: "50%", margin: "auto"}}>
      <div>
        <form className="m-4" onSubmit={handleSubmit}>
          <div className="credit-card w-full lg:w-3/4 sm:w-auto shadow-lg mx-auto rounded-xl bg-white">
            ...
            <footer className="p-4" style={{margin: "auto"}}>
              <Button
                type="submit"
            ...
            <form onSubmit={handleTransfer}>
              <div className="my-3">
                <input
                  ...
                  placeholder="Recipient address" style={{marginLeft: "25%",width:"50%"}}
                />
              </div>
              <div className="my-3">
                <input
                  ...
                  name="amount"
                  className="input input-bordered block w-full focus:ring focus:outline-none"
                  placeholder="Amount to transfer" style={{marginLeft: "25%",width:"50%"}}
                />
              </div>
